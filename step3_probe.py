...
def filter_training_rows(df, train_cue_type):

    train_df = df.copy()

    # --------------------------------------------------------
    # ONLY BEFORE CONDITION
    # --------------------------------------------------------

    train_df = train_df[
        train_df["location"] == "before"
    ]
...
def main():
    ...
    y_train_full = get_label_array(train_df)
    ...
    for layer in tqdm(range(n_layers)):
        ...
        X_train = X_train_full[train_split]
        y_train = y_train_full[train_split]

        X_test = X_train_full[test_split]
        y_test = y_train_full[test_split]
